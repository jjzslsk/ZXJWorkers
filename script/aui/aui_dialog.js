...
(function( window, undefined ) {
    "use strict";
    var closeListenCancel=false;//关闭里面的监听事件取消
    var auiDialog = function(isCloseListenCancel) {
    	closeListenCancel=isCloseListenCancel=undefined ? false:isCloseListenCancel;
    };
    var isShow = false;
    auiDialog.prototype = {
        params: {
