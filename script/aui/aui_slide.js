...
(function(window) {
	...
	auiSlide.prototype._init = function(options) {
		...
		this.index=this.options.index;//索引值
...
//		this.options.pageCount(this.slideNodeList.length);
		...
		if(this.slideNodeListLength > 1) {
			if(this.options.pageShow){
				this.createPagination(this.index);
	        ...
	        this.slideTo(this.index, -this.slideWrapWidth, this.options.speed);
	        this.slideTo(this.getCircle(this.index), 0, this.options.speed);
